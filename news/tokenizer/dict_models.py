from news.tokenizer.base_tokenizer import BaseTokenizer
from news.tokenizer.utils import load_n_grams
__author__ = "Ha Cao Thanh"
__copyright__ = "Copyright 2018, DeepAI-Solutions"


class LongMatchingTokenizer(BaseTokenizer):
    def __init__(self, bi_grams_path='./news/tokenizer/bi_grams.txt', tri_grams_path='./news/tokenizer/tri_grams.txt'):
        """
        Initial config
